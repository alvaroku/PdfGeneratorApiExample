...
- **Templates (.razor)** para generar el contenido HTML del PDF
- **itext7.pdfhtml y itext7.bouncy-castle-adapter** para renderizar el PDF
- **Dependency Injection (DI)** y configuración en `Program.cs`
- **Visual Studio / VS Code** para desarrollo
